...
const Cards = () => {
  return (
    ...
    <div className="rounded-xl relative">
        <div className="absolute w-full h-full bg-black/30 text-white text-center">
            <p className="font-bold text-2xl px-2 pt-14 mb-4">Find a professional locksmith</p>
            <button className="border hover:bg-white hover:text-black duration-300 text-white bg-black mx-2 bottom-4 rounded px-4 py-2"><Link href="/Find">Find a Locksmith</Link></button>
        </div>
